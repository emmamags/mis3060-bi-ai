# 1A — Specifications
I am a student in a Business Inteligence and AI class, and I am learning to vibe code. Please produce one single Python script that performs all of the following 17 steps in a single run. Do not perform the following items in sperate scripts. Let me know if you need any clarification on any of these items.  
